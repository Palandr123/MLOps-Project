...
demo = gr.Interface(
    ...
    inputs = [
        ...
        gr.Dropdown(label = 'condition', choices=uniques['model']),
        gr.Dropdown(label = 'cylinders', choices=uniques['model']),
        ...
        gr.Dropdown(label = 'transmission', choices=uniques['title_status']),
